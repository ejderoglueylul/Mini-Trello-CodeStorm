...
# Proje Tanımı
Mini Trello projesi, ekip içerisinde görevlerin planlanmasını, yönetilmesini ve takip edilmesini kolaylaştırmak amacıyla geliştirilen bir proje yönetim uygulamasıdır. Bu uygulama Python programlama dili kullanılarak geliştirilecek olup arayüz kısmında PyQt kütüphanesi kullanılacaktır.

Projenin temel amacı, kullanıcıların görevleri kolay bir şekilde oluşturabilmesi, düzenleyebilmesi ve görevlerin durumlarını takip edebilmesidir. Uygulama Trello benzeri bir mantık ile çalışacak ve kanban board yapısını kullanacaktır.
